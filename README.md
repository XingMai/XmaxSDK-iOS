...
// 1. Set your API key (placeholder only).
let apiKey = "xxxxx"

// 2. Create the client and realtime manager.
...
// 6. Bind the generated stream to the same view.

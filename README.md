...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Our models run efficiently on a single RTX 5090 GPU, reducing inference costs by orders of magnitude compared to setups requiring datacenter GPUs like the NVIDIA H100.</td>

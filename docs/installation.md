...
This guide covers manual integration of XmaxSDK 1.0.5.
...
Download
[`XmaxSDK-1.0.5.xcframework.zip`](https://github.com/XingMai/XmaxSDK-iOS/releases/download/1.0.5/XmaxSDK-1.0.5.xcframework.zip)
